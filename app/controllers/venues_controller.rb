class VenuesController < ApplicationController
  def index
    ...
    @venues = @q.result(:distinct => true).includes(:dishes, :bookmarkeds, :user).page(params[:page]).per(10)
  ...
  def create
    ...
    @venue.dishesyoulove = params[:dishesyoulove]
    @venue.populardishes = params[:populardishes]
